...
<html lang="en">
  <head>
    ...
    <!-- Theme color -->
    <link id="switcher" href="{{ url('frontend/css/theme-color/green-theme.css') }}" rel="stylesheet">
    <!-- <link id="switcher" href="css/theme-color/bridge-theme.css" rel="stylesheet"> -->
    <!-- Top Slider CSS -->
    <link href="{{ url('frontend/css/sequence-theme.modern-slide-in.css') }}" rel="stylesheet" media="all">
    ...
    <link href="{{ url('frontend/magiczoomplus/magiczoomplus.css') }}" rel="stylesheet">
    <script src="{{ url('frontend/magiczoomplus/magiczoomplus.js') }}"></script>
  </head>
  <body> 
     <!-- wpf loader Two -->
